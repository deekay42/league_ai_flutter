...
#ifndef PLUGINS_FBFUNCTIONS_WINDOWS_INCLUDE_FBFUNCTIONS_FBFUNCTIONS_PLUGIN_H_
#define PLUGINS_FBFUNCTIONS_WINDOWS_INCLUDE_FBFUNCTIONS_FBFUNCTIONS_PLUGIN_H_
...
#else
#define FBFUNCTIONS_PLUGIN_EXPORT
#endif
