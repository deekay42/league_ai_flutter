...
void showOpenPanel(BTNonceCallback callback,
    {String initialDirectory,
    List<String> allowedFileTypes,
    bool allowsMultipleSelection,
    bool canSelectDirectories,
    String confirmButtonText}) {
  final options = BTNonceConfigurationOptions(
      initialDirectory: initialDirectory,
      allowedFileTypes: allowedFileTypes,
      allowsMultipleSelection: allowsMultipleSelection,
      canSelectDirectories: canSelectDirectories,
      confirmButtonText: confirmButtonText);
  BTNonceChannelController.instance
      .show(BTNonceType.open, options, callback);
}
...
/// - [allowedFileTypes] restricts selection to the given file types.
/// - [confirmButtonText] overrides the button that confirms selection.
void showSavePanel(BTNonceCallback callback,
    {String initialDirectory,
  ...
  final options = BTNonceConfigurationOptions(
      ...
      confirmButtonText: confirmButtonText);
  BTNonceChannelController.instance
      .show(BTNonceType.save, options, callback);
}
