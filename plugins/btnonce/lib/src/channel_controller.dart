...
const String _kShowSavePanelMethod = 'BTNonce.Show.Save';
...
class BTNonceConfigurationOptions {
  /// Creates a new configuration options object with the given settings.
  const BTNonceConfigurationOptions(
...
class BTNonceChannelController {
  ...
  void show(BTNonceType type, BTNonceConfigurationOptions options,
      BTNonceCallback callback) {
    try {
      final methodName = type == BTNonceType.open
      ...
      _channel
        ...
        final result =
            paths == null ? BTNonceResult.cancel : BTNonceResult.ok;
