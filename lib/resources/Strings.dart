class Strings {
  static const String name = "League AI";
  static const String buildRec = "The best item buy is:";
  static const String sub = "Subscribe";
  // static const List<String> instructions = ["1. Start your League AI Desktop client",
...
static const List<String> instructionsDesktop = ["1. Start your League AI app on your phone", "2. Press <Tab> while in game"];
  ...
  // static const List<String> instructionsDesktop = ["1. Start the League AI Desktop App, then the mobile app, then a new game of League of Legends.",
  // "2. If you have a second monitor drag the League AI Desktop App window on your second screen so the game does not cover it",
  ...
  // ];
  static const String mobileWelcome = "1. Download the Windows app on your computer: http://leagueai.gg\n\n2. Scan the QR code in the Windows app to complete the pairing.";
  static const String desktopWelcome = "1. Download the League AI app on your phone.\n\n2. Scan the QR Code with your League AI app to complete the pairing.";
  ...
  static const List<String> marketing = ["Unleash the power of AI on your games", "Real-time, in-game","Specific to matchup and game state", "No more static, outdated build paths", "Millions of challenger games analyzed", "Up-to-date with the latest patch",  "Only the highest win % builds"];
